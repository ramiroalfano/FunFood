...
import { firestoreDb } from '../../firebase/FirebaseConfig'; // Adjusted import path
import { collection, getDocs, updateDoc, doc, increment } from 'firebase/firestore';
import './Menu.css'; // Assuming Menu.css is in the same directory or adjust path
import MenuCard from './MenuCard';

const DAYS = ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes']; // You can adjust days here
...
const Menu = () => {
    ...
    const fetchMenuData = async () => {
        try {
            console.log("Obteniendo datos del menú desde Firestore...");
            const menuRef = collection(firestoreDb, 'card'); // Using 'card' collection
    ...
    const handlePurchase = async () => {
        ...
        try {
            ...
            console.log("Ítems seleccionados para compra:", selectedItems);
            ...
            // Actualizar la lista de menú después de la compra
            await fetchMenuData();
            
            // Mostrar mensaje de éxito
            setShowSuccess(true);
            setSelectedItems([]); // Clear selected items after purchase
